...
def test_H_M():
    ...
    '''
    hg = hexgame.Hexgame(8)
    #p1 = game.Minmax_player(hg.clone(),hexgame.hexgame_eval)
    #p1 = game.Human_hex_player(hg.clone())
    p1 = mcts.MCTS_player(hg.clone(),iters=10000)
    p1.set_color(-1)
    p2 = game.Human_hex_player(hg.clone())
    p2.set_color(+1)
...
def test_H_A():
    ...
    '''
    hg = hexgame.Hexgame(8)
    p1 = game.Alphabeta_player(hg.clone(),hexgame.hexgame_eval)
    p1.set_color(-1)
    p2 = mcts.MCTS_player(hg.clone(), iters=10000)
